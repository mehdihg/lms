...
export const useComments=({params}:GetCommentsProps)=>{
  const {data , refetch,isFetchingNextPage,error,hasNextPage,fetchNextPage}=  useInfiniteQuery({
    ...
    return {data,refetch,isFetchingNextPage,error,hasNextPage,fetchNextPage}
}